    ...
    <el-dialog class="dialog" :title="title" :visible.sync="visible" :before-close="handleClose">
        <el-form :model="form" class="form">
            ...
            <el-form-item label="MAC地址" :label-width="formLabelWidth">
                <el-input v-model="form.mmac" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item label="位置" :label-width="formLabelWidth">
                <el-select v-model="form.locationId" placeholder="" class="select">
                    <el-option v-for="position in positionList" :key="position.id" :label="position.name" :value="position.id"></el-option>
                </el-select>
            </el-form-item>
...
export default {
    ...
    props: ['visible', 'edit', 'positionList'],
    data () {
        return {
